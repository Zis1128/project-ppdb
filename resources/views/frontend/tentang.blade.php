...
@section('content')
    ...
    <section class="relative bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-4xl md:text-5xl font-bold mb-4">Tentang SMK ISLAM YPI 2 WAY JEPARA</h1>
                ...
                <div>
                    ...
                    <div class="prose prose-lg text-gray-600">
                        ...
                        <p class="mb-4">
                            ...
                            karunia-Nya.
                            Selamat datang di website resmi SMK ISLAM YPI 2 WAY JEPARA.
                        </p>
                        <p class="mb-4">
                            SMK ISLAM YPI 2 WAY JEPARA adalah lembaga pendidikan kejuruan yang berkomitmen untuk mencetak
                            generasi muda
                            yang tidak hanya
    ...
    <section class="py-16 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                Daftarkan diri Anda sekarang dan raih masa depan cemerlang bersama SMK ISLAM YPI 2 WAY JEPARA
            </p>
