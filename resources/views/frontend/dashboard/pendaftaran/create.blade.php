...
@section('page-title', 'Form Pendaftaran Baru')
    ...
    <div x-data="{
        ...
        <div class="mb-8 bg-white rounded-xl shadow-sm p-6">
            <div class="flex items-center justify-between mb-4">
                <div class="flex-1">
                    <h3 class="text-lg font-semibold text-gray-900">Proses Pendaftaran</h3>
                    <p class="text-sm text-gray-600">Step <span x-text="currentStep"></span> dari <span
                            x-text="totalSteps"></span></p>
                </div>
                <div class="text-sm text-gray-600">
                    <span x-text="Math.round((currentStep / totalSteps) * 100)"></span>% selesai
                </div>
            </div>
        ...
        <!-- Form -->
        <form action="{{ route('dashboard.pendaftaran.store') }}" method="POST" class="space-y-6">
            @csrf
                    ...
                    @foreach ($jalurMasuks as $jalur)
                        <label
                            ...
                            <input type="radio" name="jalur_masuk_id" value="{{ $jalur->id }}" class="sr-only peer"
                                required {{ old('jalur_masuk_id') == $jalur->id ? 'checked' : '' }}>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="tel" id="no_hp_siswa" name="no_hp_siswa" value="{{ old('no_hp_siswa') }}"
                                required
                                class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
            ...
            <div x-show="currentStep === 3" x-transition class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="space-y-8">
                    ...
                    <div class="border-l-4 border-blue-500 pl-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="tel" id="no_hp_ayah" name="no_hp_ayah" value="{{ old('no_hp_ayah') }}"
                                    class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-l-4 border-pink-500 pl-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="tel" id="no_hp_ibu" name="no_hp_ibu" value="{{ old('no_hp_ibu') }}"
                                    class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Data Wali (Opsional) -->
                    <div class="border-l-4 border-gray-400 pl-4" x-data="{ showWali: false }">
                        <div class="flex items-center justify-between mb-4">
                        ...
                        <div x-show="showWali" x-transition class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="tel" id="no_hp_wali" name="no_hp_wali" value="{{ old('no_hp_wali') }}"
                                    class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="penghasilan_ortu" name="penghasilan_ortu"
                            ...
                            <option value="1000000" {{ old('penghasilan_ortu') == '1000000' ? 'selected' : '' }}>
                                < Rp 1.000.000</option>
                            <option value="2500000" {{ old('penghasilan_ortu') == '2500000' ? 'selected' : '' }}>Rp
                                1.000.000 - Rp 2.500.000</option>
                            <option value="5000000" {{ old('penghasilan_ortu') == '5000000' ? 'selected' : '' }}>Rp
                                2.500.000 - Rp 5.000.000</option>
                            <option value="10000000" {{ old('penghasilan_ortu') == '10000000' ? 'selected' : '' }}>Rp
                                5.000.000 - Rp 10.000.000</option>
                            <option value="15000000" {{ old('penghasilan_ortu') == '15000000' ? 'selected' : '' }}>> Rp
                                10.000.000</option>
                        </select>
                    </div>
                </div>
            ...
            <div x-show="currentStep === 4" x-transition class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" id="tahun_lulus" name="tahun_lulus"
                                value="{{ old('tahun_lulus', date('Y')) }}" required min="2010"
                                max="{{ date('Y') + 1 }}"
                                class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="nilai_un" name="nilai_un" value="{{ old('nilai_un') }}"
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <select id="jurusan_pilihan_1" name="jurusan_pilihan_1" required
                            ...
                            @foreach ($jurusans as $jurusan)
                                <option value="{{ $jurusan->id }}" {{ $jurusan->kuotaHabis() ? 'disabled' : '' }}>
                                    {{ $jurusan->nama }}
                                    (Sisa Kuota: {{ $jurusan->kuota_tersisa }})
                                    @if ($jurusan->kuotaHabis())
                                        - PENUH
                                    @endif
                                </option>
                            @endforeach
                        ...
                        <select id="jurusan_pilihan_2" name="jurusan_pilihan_2"
                            ...
                            @foreach ($jurusans as $jurusan)
                                <option value="{{ $jurusan->id }}"
                                    {{ old('jurusan_pilihan_2') == $jurusan->id ? 'selected' : '' }}>
                    ...
                    <div class="mt-8 p-6 bg-gray-50 rounded-lg border border-gray-200">
                        ...
                        <div class="space-y-2 text-sm">
                            <p><span class="text-gray-600">Jalur Masuk:</span> <span class="font-medium"
                                    id="summary-jalur">-</span></p>
                            <p><span class="text-gray-600">Nama Lengkap:</span> <span class="font-medium"
                                    id="summary-nama">-</span></p>
                            <p><span class="text-gray-600">NISN:</span> <span class="font-medium"
                                    id="summary-nisn">-</span></p>
                            <p><span class="text-gray-600">Asal Sekolah:</span> <span class="font-medium"
                                    id="summary-sekolah">-</span></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <label for="pernyataan" class="ml-3 text-sm text-gray-700">
                            Saya menyatakan bahwa data yang saya isi adalah benar dan dapat dipertanggungjawabkan.
                            Apabila dikemudian hari terbukti data yang saya berikan tidak benar, maka saya bersedia menerima
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateSummary() {
                const jalur = document.querySelector('input[name="jalur_masuk_id"]:checked');
                const nama = document.getElementById('nama_lengkap');
                const nisn = document.getElementById('nisn');
                const sekolah = document.getElementById('asal_sekolah');

                if (jalur) document.getElementById('summary-jalur').textContent = jalur.parentElement.querySelector(
                    '.text-lg').textContent;
                if (nama) document.getElementById('summary-nama').textContent = nama.value || '-';
                if (nisn) document.getElementById('summary-nisn').textContent = nisn.value || '-';
                if (sekolah) document.getElementById('summary-sekolah').textContent = sekolah.value || '-';
            }
